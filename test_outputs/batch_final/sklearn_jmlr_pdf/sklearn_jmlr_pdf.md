...
Parietal, INRIA Saclay Neurospin, Bˆ at 145, CEA Saclay 91191 Gif sur Yvette - France
...
Clermont Universit´ e, IFMA, EA 3867, LaMI BP 10448, 63000 Clermont-Ferrand - France
...
c © 2011 Fabian Pedregosa, Ga¨ el Varoquaux, Alexandre Gramfort, Vincent Michel, Bertrand Thirion, Olivier Grisel, Mathieu Blondel, Peter Prettenhofer, Ron Weiss, Vincent Dubourg, Jake Vanderplas, Alexandre Passos, David Cournapeau, Matthieu Brucher, Matthieu Perrot and ´ Edouard Duchesnay

## Scikit-learn: Machine Learning in Python

FABIAN.PEDREGOSA@INRIA.FR GAEL.VAROQUAUX@NORMALESUP.ORG ALEXANDRE.GRAMFORT@INRIA.FR VINCENT.MICHEL@LOGILAB.FR BERTRAND.THIRION@INRIA.FR
...
MATTHIEU.PERROT@CEA.FR EDOUARD.DUCHESNAY@CEA.FR

LNAO Neurospin, Bˆ at 145, CEA Saclay 91191 Gif sur Yvette - France
...
Community-driven development. Webase our development on collaborative tools such as git, github and public mailing lists. External contributions are welcome and encouraged.
...
Numpy: the base data structure used for data and model parameters. Input data is presented as numpy arrays, thus integrating seamlessly with other scientific Python libraries. Numpy's viewbased memory model limits copies, even when binding with compiled code (Van der Walt et al., 2011). It also provides basic arithmetic operations.
...
3. K.J. Milmann and M. Avaizis, editors. Scientific Python , volume 11 of Computing in Science &amp; Engineering . IEEE/AIP, March 2011.
## 4. S.M. Omohundro. Five balltree construction algorithms. ICSI Technical Report TR-89-063, 1989.
...
- S. Sonnenburg, G. R¨ atsch, S. Henschel, C. Widmer, J. Behr, A. Zien, F. de Bona, A. Binder, C. Gehl, and V. Franc. The SHOGUN machine learning toolbox. Journal of Machine Learning Research , 11:1799-1802, 2010.
