...
$$C (G) = - \log(4) + KL \left (p_{data} \left \| \frac{ p_{data} + p_{_{G}}} { 2} \right) + KL \left (p_{g} \left \| \frac{ p_{_{G}} + p_{_{g}}} { 2} \right) \right)$$
...
$$C (G) = - \log(4) + 2 \cdot JSD \left (p_{\text{data}} \left \| p_{g} \right)$$
