## On this page
  * [ Overview ](https://developers.llamaindex.ai/python/framework/#_top)
  * [ Introduction ](https://developers.llamaindex.ai/python/framework/#introduction)
    * [ What are agents? ](https://developers.llamaindex.ai/python/framework/#what-are-agents)
    * [ What are workflows? ](https://developers.llamaindex.ai/python/framework/#what-are-workflows)
    * [ What is context augmentation? ](https://developers.llamaindex.ai/python/framework/#what-is-context-augmentation)
    * [ LlamaIndex is the framework for Context-Augmented LLM Applications ](https://developers.llamaindex.ai/python/framework/#llamaindex-is-the-framework-for-context-augmented-llm-applications)
  * [ Use cases ](https://developers.llamaindex.ai/python/framework/#use-cases)
    * [ 👨‍👩‍👧‍👦 Who is LlamaIndex for? ](https://developers.llamaindex.ai/python/framework/#-who-is-llamaindex-for)
  * [ Getting Started ](https://developers.llamaindex.ai/python/framework/#getting-started)
    * [ 30 second quickstart ](https://developers.llamaindex.ai/python/framework/#30-second-quickstart)
  * [ LlamaCloud ](https://developers.llamaindex.ai/python/framework/#llamacloud)
  * [ Community ](https://developers.llamaindex.ai/python/framework/#community)
    * [ Getting the library ](https://developers.llamaindex.ai/python/framework/#getting-the-library)
    * [ Contributing ](https://developers.llamaindex.ai/python/framework/#contributing)
  * [ LlamaIndex Ecosystem ](https://developers.llamaindex.ai/python/framework/#llamaindex-ecosystem)
...
Get help and meet collaborators on Discord, Twitter, LinkedIn, and learn how to contribute to the project.
  * [Related projects](https://developers.llamaindex.ai/python/framework/#related-projects)
...
### What are agents?
[](https://developers.llamaindex.ai/python/framework/#what-are-agents)
...
### What are workflows?
[](https://developers.llamaindex.ai/python/framework/#what-are-workflows)
...
[](https://developers.llamaindex.ai/python/framework/#what-is-context-augmentation)
...
[](https://developers.llamaindex.ai/python/framework/#llamaindex-is-the-framework-for-context-augmented-llm-applications)
...
## Use cases
[](https://developers.llamaindex.ai/python/framework/#use-cases)
...
[](https://developers.llamaindex.ai/python/framework/#-who-is-llamaindex-for)
...
[](https://developers.llamaindex.ai/python/framework/#30-second-quickstart)
...
## LlamaCloud
[](https://developers.llamaindex.ai/python/framework/#llamacloud)
...
## Community
[](https://developers.llamaindex.ai/python/framework/#community)
...
### Getting the library
[](https://developers.llamaindex.ai/python/framework/#getting-the-library)
  * LlamaIndex Python 
...
### Contributing
[](https://developers.llamaindex.ai/python/framework/#contributing)
...
[](https://developers.llamaindex.ai/python/framework/#llamaindex-ecosystem)
...
[ Previous   
Workflows API Reference 🔗 ](https://developers.llamaindex.ai/python/workflows-api-reference/) [ Next   
