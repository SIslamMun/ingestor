...
$$f ( y _ { t } , d , [ \text{Criticue} ] ) = p ( y _ { t } | x , d , y _ { < t } ) ) + \mathcal { S } [ \text{Criticue} ] , \text{where}$$

$$\mathcal { S } ( \text{Criticique} ) = \sum _ { G \in \mathcal { G } } w ^ { G } s _ { t } ^ { G } \text{ for } \mathcal { G } = \{ \underline { [ \text{IsR} , \underline { [ \text{IsSup} } , \underline { [ \text{IsUse} } } ] } \} ,$$
...
$$s ( \text{IsREL} ) = \frac{ p ( \text{IsREL} ) = \text{RELVEANT} ) } { p ( \text{IsREL} ) = \text{RELVEANT} ) + p ( \text{IsREL} ) = \text{IRRELEVANT} ) } .$$

For ISSUP , we compute the score as follows:

$$s ( \text{IsReal} ) = \frac{ p ( \text{IsSup} ) = F U L L Y ) } { S } + 0 . 5 \times \frac{ p ( \text{IsSup} ) = P A R T I A L L Y ) } { S } ,$$
...
$$s ( [ \text{IsUsr} ] ) = \sum _ { i } ^ { 5 } w _ { i } \frac{ p ( [ \text{IsUsr} ] = i ) } { S } ,$$

$$\text{where} \, S = \sum _ { t \in \{ 1 , 2 , 3 , 4 , 5 \} } p ( \boxed { \text{IsUsis} } = t ) .$$

$$\boxed { \text{IsUse} } ) = \sum _ { i } w _ { i } \frac{ p ( \text{ListUse} = i ) } { S } , \\= t ) .$$
...
$$\frac{ p ( \boxed { \text{Retrieve} } = Y E S ) } { p ( \boxed { \text{Retrieve} } = Y E S ) + p ( p ( \boxed { \text{Retrieve} } = N O ) } > \delta .$$
