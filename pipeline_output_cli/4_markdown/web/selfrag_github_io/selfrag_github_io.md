...
[Akari Asai](https://akariasai.github.io/)1 [Zeqiu Wu](https://ellenmellon.github.io/)1 [Yizhong Wang](https://homes.cs.washington.edu/~yizhongw/)1,  [Avirup Sil](https://research.ibm.com/people/avi-sil)2,  [Hannaneh Hajishirzi](https://homes.cs.washington.edu/~hannaneh/)1,3, 
1University of Washington, 2IBM AI Research, 3Allen Institute for AI
[ arXiv ](https://arxiv.org/abs/2310.11511) [ Code ](https://github.com/AkariAsai/self-rag) [ Model (7B) ](https://huggingface.co/selfrag/selfrag_llama2_7b) [ Model (13B) ](https://huggingface.co/selfrag/selfrag_llama2_13b) [ Data ](https://huggingface.co/datasets/selfrag/selfrag_train_data) [ HF Space ](https://huggingface.co/papers/2310.11511)
...
![BUFFET teaser.](https://selfrag.github.io/static/images/teaser_self_rag_v8.png)
## Summary
...
![special tokens](https://selfrag.github.io/static/images/special_tokens.png)
...
![special tokens](https://selfrag.github.io/static/images/training_examples.png)
...
![results](https://selfrag.github.io/static/images/results.png)
### Analysis
![analysis results](https://selfrag.github.io/static/images/analysis_result_1.png)
#### (A) Ablations
...
[ ](https://selfrag.github.io/) [ ](https://akariasai.github.io/)
This website is licensed under a [Creative Commons Attribution-ShareAlike 4.0 International License](http://creativecommons.org/licenses/by-sa/4.0/). 
This means you are free to borrow the [source code](https://github.com/nerfies/nerfies.github.io) of this website, we just ask that you link back to this page in the footer. Please remember to remove the analytics code included in the header of the website which you do not want on your website. 
